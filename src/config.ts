...
// ---------------------------------------------------------------------------
export const COLORS = {
  // --- 3D viewport background + ground grid (white "studio" look) ---
  sceneBg: '#ffffff', // pure white viewport — matches the rest of the app
  gridCell: '#dde3ea', // fine grid lines on the white floor
  gridSection: '#aeb9c6', // major grid lines

  // NOTE: the viewport background is pure white, so component grays are kept
  // MEDIUM (not light) — light parts wash out on white. Directional shading +
  // the contact shadow then give them form.
  extrusion: '#39404d', // dark gray aluminum extrusion
  cell: '#8f96a1', // S-beam steel body — medium gray, reads on white
  cellAccent: '#686e78',
  plate: '#3f8ac4', // blue aluminum plate (rendered semi-transparent)
  clevis: '#676d76',
  sting: '#636974',
  bracket: '#737a85',
  fuselage: '#79808c', // aircraft body — medium gray for contrast on white
  wing: '#6f7783',
  tail: '#6f7783',
  canopy: '#2b3a4a',
